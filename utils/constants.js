...
const exitMessage = 'Вы вышли из аккаунта';
const emailBusyMessage = 'Такой Email уже занят';
const movieNotFoundMessage = 'Фильм не найден';
const movieDeleteMessage = 'Фильм удален';
const notDeleteMovieMessage = 'Нельзя удалять не вами добавленный фильм';
